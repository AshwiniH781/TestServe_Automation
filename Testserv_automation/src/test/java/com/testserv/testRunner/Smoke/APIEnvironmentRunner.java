...
"src/test/resources/Smokefeaturefile/APItesting.feature" }, plugin = {"json:target/cucumber-json-report.json"}, 
		tags = {"@APIEnvironment"})
public class APIEnvironmentRunner extends ReportConfigurations{
