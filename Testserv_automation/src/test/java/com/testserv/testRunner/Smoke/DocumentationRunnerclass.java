...
"src/test/resources/Smokefeaturefile/Documentation.feature" }, plugin = {"json:target/cucumber-json-report.json"}, 
		tags = {"@Documentation"})

public class DocumentationRunnerclass extends ReportConfigurations
{
