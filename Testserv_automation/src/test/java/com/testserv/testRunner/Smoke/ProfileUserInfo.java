...
"src/test/resources/Smokefeaturefile/Profile.feature" }, plugin = {"json:target/cucumber-json-report.json"}, 
		tags = {"@ProfileUserinfo"})

public class ProfileUserInfo extends ReportConfigurations{
