...
public class ProfileStep extends BaseTest {
	private static Object uploadofselectfilePopup;
...
public void click_on_profile_image_and_upload_the_image() throws Exception {
    ...
    if(eventUtils.waitUntilElementIsPresent(driver, Prof.ProfileImage, 20)) {
        eventUtils.clickOnElement(driver, Prof.ProfileImage, "Image click", 20);
