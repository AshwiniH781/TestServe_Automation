...
"src/test/resources/featurefile/APINewRun.feature" }, plugin = {"json:target/cucumber-json-report.json"}, tags = {"@APINewRun"})


public class APIRunReport extends ReportConfigurations{
