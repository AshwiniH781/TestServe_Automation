...
"src/test/resources/featurefile/Profile.feature" }, plugin = {"json:target/cucumber-json-report.json"}, tags = {"@ProfileUserinfo"})

public class Profile extends ReportConfigurations
{
